...
public class XListView01 extends ListView implements OnScrollListener {
	...
	/** 底部View */
	private XListViewFooter01 mFooterView;
	/** 是否可以上拉加载 */
	 ...
	 * @param context
	 */
	public XListView01(Context context) {
		super(context);
		initWithContext(context);
	}
	public XListView01(Context context, AttributeSet attrs) {
		super(context, attrs);
		initWithContext(context);
	}
	public XListView01(Context context, AttributeSet attrs, int defStyle) {
	...
	private void initWithContext(Context context) {
		...
		// 初始化底部View
		mFooterView = new XListViewFooter01(context);
		// 初始化头部View高度
