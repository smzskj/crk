...
public class OfflineOutListAdapter extends BaseViewAdapter<OfflineOutListBean> {

	private String sjk, kf, ry;

	public OfflineOutListAdapter(Context context, List<OfflineOutListBean> list, String sjk, String kf, String ry) {
		super(context, list);
		this.sjk = sjk;
		this.kf = kf;
		this.ry = ry;
	...
	public OfflineOutListAdapter(Context context, List<OfflineOutListBean> list) {
		super(context, list);
	}
